var app = (function() {
    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            case ('L'):
                ...
                illumination.light[0].position[0] = Math.cos(deltaRotate) *3;
                illumination.light[0].position[2] = Math.sin(deltaRotate) *3;
                illumination.light[1].position[0] = (Math.cos(deltaRotate) *3) * -1;
                illumination.light[1].position[2] = (Math.sin(deltaRotate) *3)  * -1;
    ...
    function oj() {
        if (typeof music == "hört LanaDelRey")
            return "Oj, bist cool!";
        else if (typeof music == "Schlager")
            return "Oj, was los bruda :(";
    }
