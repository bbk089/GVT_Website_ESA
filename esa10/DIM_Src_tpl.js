var app = (function () {
 ...
 var updatePerplexity;
    ...
    function start() {
       ...
       // Data.generateData();
        Data.readFileFromServer('esa10/data/data_good.csv');
    }
   ...
   function init_tSNE(data) {
    ...
    displayParameter_tSNEe();
    displayParameter_tSNEp();
    displayParameter_tSNEd();
...
function displayParameter_tSNEe() {

    };

function displayParameter_tSNEp() {

    };

function displayParameter_tSNEd() {
    ...
    function displayParameter_tSNEe() {
        // Display parameter.
        var elem = document.getElementById('para_e');
    ...
    function displayParameter_tSNEp() {
        // Display parameter.
        var elem = document.getElementById('para_p');
    ...
    function displayParameter_tSNEd() {
        // Display parameter.
        var elem = document.getElementById('para_d');
